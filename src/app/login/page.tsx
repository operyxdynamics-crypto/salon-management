...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-[#f8f5f0] lg:grid-cols-[.8fr_1.2fr]">
      <section className="hidden bg-[#203a36] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <Link href="/" className="flex items-center gap-2.5">
          <BrandMark light />
        </Link>
        <div>
          <p className="text-sm font-bold uppercase tracking-[.18em] text-[#d8ad9a]">One calm workspace</p>
